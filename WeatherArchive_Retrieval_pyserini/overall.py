...
# Aggregate the raw_*.csv files produced by the Pyserini retrievers.  Logic is
# identical to WeatherArchive_Retrieval/overall.py; only the folder differs.
BASE_ADDRESS = "WeatherArchive_Retrieval_pyserini/retriever_eval"
